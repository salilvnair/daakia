...
const SCREENS: ScreenSpec[] = [
  { id: 'soap-envelope', label: 'SOAP — Envelope',
    ...
    directives: [ { action: 'closeAllTabs' }, { action: 'addTab', patch: BASE_PATCH }, { action: 'click', selector: 'button[data-tab="envelope"]' }, { action: 'wait', ms: 1800 } ] },
  { id: 'soap-form', label: 'SOAP — Form',
    ...
    directives: [ { action: 'closeAllTabs' }, { action: 'addTab', patch: BASE_PATCH }, { action: 'click', selector: 'button[data-tab="form"]' }, { action: 'wait', ms: 600 } ] },
  { id: 'soap-headers', label: 'SOAP — Headers',
    ...
    directives: [ { action: 'closeAllTabs' }, { action: 'addTab', patch: { ...BASE_PATCH, headers: [ { id: 'h1', key: 'X-Client-Id', value: 'daakia-wiki-demo', enabled: true }, { id: 'h2', key: 'X-Correlation-Id', value: '{{$random.uuid}}', enabled: true } ] } }, { action: 'click', selector: 'button[data-tab="headers"]' }, { action: 'wait', ms: 600 } ] },
  { id: 'soap-wssecurity', label: 'SOAP — WS-Security',
    ...
    directives: [ { action: 'closeAllTabs' }, { action: 'addTab', patch: { ...BASE_PATCH, soapWsSecurity: { enabled: true, username: 'demo', password: 'demo-pass', passwordType: 'PasswordDigest', addNonce: true, addCreated: true, addTimestamp: true, timestampTtl: 300 } } }, { action: 'click', selector: 'button[data-tab="wssecurity"]' }, { action: 'wait', ms: 600 } ] },
  { id: 'soap-authorization', label: 'SOAP — Authorization',
    ...
    directives: [ { action: 'closeAllTabs' }, { action: 'addTab', patch: { ...BASE_PATCH, authType: 'basic', authData: { username: 'demo', password: 'demo-password' } } }, { action: 'click', selector: 'button[data-tab="auth"]' }, { action: 'wait', ms: 600 } ] },
  { id: 'soap-attachments', label: 'SOAP — Attachments',
    ...
    directives: [ { action: 'closeAllTabs' }, { action: 'addTab', patch: BASE_PATCH }, { action: 'click', selector: 'button[data-tab="attachments"]' }, { action: 'wait', ms: 600 } ] },
  { id: 'soap-assertions', label: 'SOAP — Assertions',
    ...
    directives: [ { action: 'closeAllTabs' }, { action: 'addTab', patch: RESPONSE_PATCH }, { action: 'click', selector: 'button[data-tab="assertions"]' }, { action: 'wait', ms: 600 } ] },
  ...
  { id: 'soap-wsdl', label: 'SOAP — WSDL Browser',
    ...
    directives: [ { action: 'closeAllTabs' }, { action: 'addTab', patch: BASE_PATCH }, { action: 'click', selector: 'button[data-tab="wsdl"]' }, { action: 'wait', ms: 600 } ] },
  ...
  { id: 'soap-response-body', label: 'SOAP — Response Body',
    ...
    directives: [ { action: 'closeAllTabs' }, { action: 'addTab', patch: RESPONSE_PATCH }, { action: 'setResponseSubtab', responseProtocol: 'soap', subtab: 'body' }, { action: 'wait', ms: 1800 } ] },
  { id: 'soap-response-headers', label: 'SOAP — Response Headers',
    ...
    directives: [ { action: 'closeAllTabs' }, { action: 'addTab', patch: RESPONSE_PATCH }, { action: 'setResponseSubtab', responseProtocol: 'soap', subtab: 'headers' }, { action: 'wait', ms: 600 } ] },
  { id: 'soap-response-tests', label: 'SOAP — Response Tests',
    ...
    directives: [ { action: 'closeAllTabs' }, { action: 'addTab', patch: RESPONSE_PATCH }, { action: 'setResponseSubtab', responseProtocol: 'soap', subtab: 'tests' }, { action: 'wait', ms: 600 } ] },
];
