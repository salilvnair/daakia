...
export function logProtocolMessage(msg: Record<string, unknown>) {
 ...
 console.group('%c Settings Changed — AI Providers', 'color:#8b5cf6;font-weight:bold;font-size:11px');
 ...
 console.log(`%c Setting Saved: ${msg.key || msg.section || ''}`, 'color:#8b5cf6;font-weight:bold', { key: msg.key, value: msg.value, section: msg.section });
  }
}
