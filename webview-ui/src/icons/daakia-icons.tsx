...
/** GitHub logo (octocat) — used for the git-sync rail button and Settings section. */
export function GitHubIcon(props: IconProps) {
  return (
    <svg {...withDefaults(props)} fill="currentColor" stroke="none">
      <path d="M12 .5C5.73.5.5 5.73.5 12c0 5.08 3.29 9.38 7.86 10.9.58.1.79-.25.79-.56 0-.28-.01-1.02-.02-2-3.2.7-3.88-1.54-3.88-1.54-.52-1.33-1.28-1.68-1.28-1.68-1.04-.71.08-.7.08-.7 1.15.08 1.76 1.18 1.76 1.18 1.03 1.75 2.7 1.25 3.36.96.1-.75.4-1.25.73-1.54-2.55-.29-5.24-1.28-5.24-5.69 0-1.26.45-2.29 1.18-3.09-.12-.29-.51-1.46.11-3.05 0 0 .97-.31 3.18 1.18a11 11 0 0 1 5.8 0c2.2-1.49 3.17-1.18 3.17-1.18.63 1.59.24 2.76.12 3.05.74.8 1.18 1.83 1.18 3.09 0 4.42-2.69 5.39-5.25 5.68.41.36.78 1.06.78 2.14 0 1.55-.01 2.79-.01 3.17 0 .31.2.67.8.56A10.52 10.52 0 0 0 23.5 12C23.5 5.73 18.27.5 12 .5Z"/>
    </svg>
  );
}
...
/**
 * The Daakia mark itself — the artwork from `images/daakia-side.svg`, which is
 * the icon on the Marketplace listing and in the editor's activity bar.
 *
 * Inline rather than an `<img>` because a webview cannot reach into the
 * extension's `images/` folder without a URI handed to it, and the About screen
 * is the one place that has to show the real thing rather than a stand-in. It
 * carries its own colours, so it does not take `currentColor`.
 *
